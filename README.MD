...
* GET /auto/:token : User auto Login ( 유저 자동 로그인 )

> Response

    Same /signin  ( /signin 과 같습니다. )

* POST /fb/app : Social Login ( 소셜 로그인 )
...
* POST /delUser : Remove User ( 회원 탈퇴 )
